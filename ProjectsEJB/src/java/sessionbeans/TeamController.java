...
public class TeamController implements Serializable {
    ...
    @EJB
    private sessionbeans.TeamFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/EJBProject").getString("TeamCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/EJBProject").getString("TeamUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/EJBProject").getString("TeamDeleted"));
        if (!JsfUtil.isValidationFailed()) {
            selected = null; 
            items = null;    
        }
    ...
    public Team getTeam(java.lang.Integer id) {
        return getFacade().find(id);
    }

    public List<Team> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Team> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class TeamControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Team) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Team.class.getName()});
                return null;
            }
        }
