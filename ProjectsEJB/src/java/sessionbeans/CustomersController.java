...
public class CustomersController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/EJBProject").getString("CustomersCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/EJBProject").getString("CustomersUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/EJBProject").getString("CustomersDeleted"));
        if (!JsfUtil.isValidationFailed()) {
            selected = null; 
            items = null;    
        }
    ...
    public static class CustomersControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Customers) {
                ...
                return getStringKey(o.getCustId());
            } else {
